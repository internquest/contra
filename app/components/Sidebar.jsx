...
const Sidebar = () => {
    ...
    return (
        <div >
            <div className={`${pathname === '/' && 'w-[280px]'} w-[64px]`}></div>
            <nav>
                <div className="relative">
                    <ul>
                        <div style={{ width: sidebarhover || pathname === '/' ? '304px' : '64px', paddingRight: sidebarhover || pathname === '/' ? '24px' : '0' }} className={` duration-200 outline-[none] box-border m-0 p-0 block  inset-0 fixed z-[101] `}>
                            <nav onMouseEnter={() => setSidebarhover(true)} onMouseLeave={() => setSidebarhover(false)} className="outline-[none] box-border m-0 pt-[16px] px-[12px] pb-[24px] flex items-center flex-col overscroll-contain flex-1 h-screen relative [scrollbar-width:none] bg-[rgb(255,_255,_255)] border-r-[1px_solid_rgb(242,_244,_247)]">
                                <div className="outline-[none] box-border m-0 pt-0 px-0 pb-[26px] flex items-center [flex-flow:row] w-full text-[white] relative justify-between">
                                ...
                                <li className="outline-[none] box-border m-0 p-0 flex items-center w-full mb-[2px] leading-[0]">
                                    <a aria-label="User menu" data-radix-collection-item="" className="outline-[none] box-border m-0 p-0 no-underline text-[rgb(20,_23,_31)] cursor-pointer relative flex w-full select-none rounded-[6px] leading-[0]">
                                        <div aria-label="user menu button" layout="INLINE" role="button" className="outline-[none] box-border m-0 px-[8px] py-[4px] w-full rounded-[8px] border-solid border border-[rgb(229,_231,_235)] cursor-pointer min-h-[64px]">
                                ...
                                <li className="outline-[none] box-border m-0 p-0 flex items-center w-full mb-[2px] leading-[0]">
                                    ...
                                    <a href="/independent/home" data-radix-collection-item="" className="outline-[none] box-border m-0 p-0 no-underline text-[rgb(20,_23,_31)] cursor-pointer   relative flex w-full select-none rounded-[6px] leading-[0] bg-[rgba(221,_216,_255,_0.48)]">
                                ...
                                <li className="outline-[none] box-border m-0 p-0 flex items-center w-full mb-[2px] leading-[0]">
                                    <a href="/discover/independents" data-radix-collection-item="" className="outline-[none] box-border m-0 p-0 no-underline text-[rgb(20,_23,_31)] cursor-pointer relative flex w-full select-none rounded-[6px] leading-[0]">
                                        <div className="outline-[none] box-border m-0 px-[12px] py-0 flex items-center w-full h-[40px] relative rounded-[8px] text-[rgb(20,_23,_31)] leading-[0] select-none max-w-[256px]">
                                            <svg fill="none" height="16" viewBox="0 0 16 16" width="16"
                                                xmlns="http://www.w3.org/2000/svg" className="outline-[none] box-border m-0 p-0 w-[16px] h-[16px] flex-shrink-0">
                                ...
                                <li className="outline-[none] box-border m-0 p-0 flex items-center w-full mb-[2px] leading-[0]">
                                    <a href="/discover/jobs" data-radix-collection-item="" className="outline-[none] box-border m-0 p-0 no-underline text-[rgb(20,_23,_31)] cursor-pointer relative flex w-full select-none rounded-[6px] leading-[0]">
                                        <div className="outline-[none] box-border m-0 px-[12px] py-0 flex items-center w-full h-[40px] relative rounded-[8px] text-[rgb(20,_23,_31)] leading-[0] select-none max-w-[256px]">
                                            <svg fill="none" focusable="false" height="24" role="img" stroke-width="1" viewBox="0 0 24 24" width="24" className="outline-[none] box-border m-0 p-0 w-[16px] h-[16px] flex-shrink-0">
